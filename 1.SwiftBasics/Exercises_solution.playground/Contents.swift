...
let yourSentence = "Incorporate \(nounArray[index1]) from the \(nounArray[index2]) here."
...
let answer = "HEY! \(didYouKnowString.uppercased())"
//: ### Exercise 3
...
//desired output = "$5.67"
let desiredOutput = "$\(numOfPennies / 100).\(numOfPennies % 100)"
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
...
let easyReversed = String(stringToReverse.reversed())
