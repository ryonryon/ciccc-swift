...
let yourSentence = "My \(nounArray[0]) broke the \(nounArray[1])."
let yourSillySentence = "I am \(nounArray[index1]). but I wanted to be \(nounArray[index2])."
//: ### Exercise 2
...
let shoutString =  "HEY! \(didYouKnowString.lowercased())"
//: ### Exercise 3
...
//desired output = "$5.67"
let numOfDollor = Double(numOfPennies) / 100
print("$\(numOfDollor)")
//: # Let or Var?
import UIKit
import Foundation
