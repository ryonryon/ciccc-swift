...
let filtered2 = numbersAsStrings.filter {
...
let canadianMoney = pricesInRupees.map { Double($0) * 0.019 }
print(canadianMoney)
//: __Problem 6__
//:
...
let goalTimes = oldTimes.map(timeIntervalFromString)
                      .map { $0 + 13 }
