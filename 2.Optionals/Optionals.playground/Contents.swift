...
// AnyObject (any class type object)
var c: AnyObject
c = UIColor.red
//c = nil
...
//y = Int(s2) // nil
// Unwrap optional
// 1. force unwrap optional with !
// print(y!)

// 2. if-let statement to safely unwrap
// if I can let "y(optional)" as "unwrappedY"
// that means y has a value
if let unwrappedY = y {
  print(unwrappedY)
} else {
  print("y is nil")
...
// Type! -> Implicitly unwrapped optional
//       - z will have a value but not yet
//       - you do not have to unwrap to use the value
var z: Int!
var string: String
string = "123"
//z = Int(string)
...
class AnotherViewController: UIViewController {
  var anotherButton: UIButton? // nil
//  var anotherButton: UIButton! // nil
  override func viewDidLoad() {
    // optional chaining
    anotherButton?.backgroundColor = .red
    
    // if-let unwrap
    if let btn = anotherButton {
...
func addTwoNumbers(first a: Int, second b: Int) -> Int {
  return a + b
}
